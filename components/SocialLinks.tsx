/** Rangée d'icônes réseaux sociaux Vegourmet (réutilisable). */
const SOCIALS: { href: string; label: string; viewBox: string; path: string }[] = [
  {
  ...
  {
    href: "https://www.tiktok.com/@vegourmetoff",
    label: "TikTok",
    viewBox: "0 0 24 24",
    path: "M16.6 5.82A4.28 4.28 0 0 1 15.54 3h-3.09v12.4a2.59 2.59 0 0 1-2.59 2.5 2.6 2.6 0 0 1-2.6-2.6c0-1.72 1.66-3.01 3.37-2.48V7.66c-3.45-.46-6.47 2.22-6.47 5.64 0 3.33 2.76 5.7 5.69 5.7 3.14 0 5.69-2.55 5.69-5.7V9.01a7.35 7.35 0 0 0 4.3 1.38V7.3a4.79 4.79 0 0 1-3.24-1.48z",
  },
];

export function SocialLinks({ className = "" }: { className?: string }) {
  return (
    <ul className={`vg-socials ${className}`} aria-label="Réseaux sociaux">
      {SOCIALS.map((s) => (
        <li key={s.label}>
          <a
            href={s.href}
            ...
            aria-label={s.label}
          >
            <svg width="20" height="20" viewBox={s.viewBox} aria-hidden="true" focusable="false">
